...
ECHO 7.- Conectar Servidor
ECHO 8.- Desactivar Servicio
ECHO 9.- Es otra oficina
...
if '%seleccion%'=='7' GOTO :eleccion7
if '%seleccion%'=='8' GOTO :eleccion8
if '%seleccion%'=='9' GOTO :home
if '%seleccion%'=='10' (GOTO :salir1) Else (GOTO :errorcdsmenu)

:errorcdsmenu
cls
TITLE OPCION INVALIDA
ECHO Usted ha introducido una opcion invalida. Intente nuevamente.
ECHO.
GOTO main
...
cls
Echo off
TITLE Revisar Not Run
Echo **********************************************
Echo  Editar archivo NOT_RUN
echo **********************************************
Title Editar archivo NOT_RUN
...
Echo **********************************************
Echo  conectar a servidor %ofi%srv1 
echo **********************************************

TITLE Conectar a servidor %ofi%srv1
net use j: /delete

net use j: \\%ofi%srv1\d$
...
cls
Echo off
TITLE Revisar conexion servidor %ofi%srv1
Echo **********************************************
Echo  Revisar conexión servidor %ofi%srv1
echo **********************************************
...
Pause
cls
start cmd.exe "net use j:moaproj\demo\cds"
GOTO Main
